...
_vehicle = [_vehicleClass,getMarkerPos "plane2",.06,1,0,"FLY"] call createMissionVehicle;
...
_hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>US Ranger's Vehicle drop</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'>A<t color='%4'> %3</t>, has been designated to fly in a vehicle.</t>", _missionType, _picture, _vehicleName, mainMissionColor, subTextColor];
