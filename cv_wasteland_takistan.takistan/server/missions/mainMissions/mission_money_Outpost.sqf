...
_hint = parseText format ["<t align='center' color='%1' shadow='2' size='1.75'>Outpost Mission</t><br/><t align='center' color='%1'>------------------------------</t><br/><t color='%2' size='1.0'>The snipers observing have relayed the position of the outpost, proceed to the GPS coords and secure the outpost</t>", _HeadColor, _subTextColour];
[nil,nil,rHINT,_hint] call RE;
_choice = ["server\missions\createUnits\smallGroup.sqf","server\missions\createUnits\midGroup.sqf","server\missions\createUnits\largeGroup.sqf"] call BIS_fnc_selectRandom;
