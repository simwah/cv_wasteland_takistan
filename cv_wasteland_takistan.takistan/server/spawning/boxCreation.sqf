...
switch(_selectedBox) do {
    ...
    case "basicGER": { // G36's everywhere...
        ...
        // Add new weapons before ammunition
        _currBox addWeaponCargoGlobal ["G36C",1];
		_currBox addWeaponCargoGlobal ["G36_C_SD_eotech",1];
		_currBox addWeaponCargoGlobal ["G36a",1];
		_currBox addWeaponCargoGlobal ["M9",2];	
        
        // Add ammunition
        _currBox addMagazineCargoGlobal ["30Rnd_556x45_G36",25];
        _currBox addMagazineCargoGlobal ["30Rnd_556x45_G36SD",25];
        _currBox addMagazineCargoGlobal ["15Rnd_9x19_M9",5];
        _currBox addMagazineCargoGlobal ["HandGrenade",10];
    };
    case "basicPMC": { // Most OP weapons in the game, this will be a saught after crate.
        ...
        // Add new weapons before ammunition
        _currBox addWeaponCargoGlobal ["M8_carbine",1];
		_currBox addWeaponCargoGlobal ["M8_carbineGL",1];
		_currBox addWeaponCargoGlobal ["AA12_PMC",1];
		_currBox addWeaponCargoGlobal ["M9",2];	
    ...
    case "basicSpecial": { // Silent weapons
        ...
        // Add new weapons before ammunition
        _currBox addWeaponCargoGlobal ["m8_compact_pmc",1];
		_currBox addWeaponCargoGlobal ["M4A1_AIM_SD_camo",1];
    ...
    case "basicSpecial2": { // BAF weapons
		...
		_currBox addWeaponCargoGlobal ["BAF_L86A2_ACOG",1];
    ...
    case "basicSpecial3": { // Misc weapons, mostly shit
		...
		_currBox addWeaponCargoGlobal ["revolver_EP1",2];	 
        ...
        _currBox addMagazineCargoGlobal ["10x_303",25];
