...
//Anti Vehicle
_leader = _group createunit ["Priest", [(_pos select 0), _pos select 1, 0], [], 0.5, "Form"];
...
//Support
_man2 = _group createunit ["CIV_EuroMan02_EP1", [(_pos select 0), _pos select 1, 0], [], 0.5, "Form"];
_man2 addMagazine "75Rnd_545x39_RPK";
_man2 addMagazine "75Rnd_545x39_RPK";
_man2 addWeapon "RPK_74";

//Rifle_man
_man3 = _group createunit ["CIV_EuroMan01_EP1", [_pos select 0, (_pos select 1) , 0], [], 0.5, "Form"];
...
//Rifle_man
_man4 = _group createunit ["RU_Citizen1", [_pos select 0, (_pos select 1) , 0], [], 0.5, "Form"];
...
//Rifle_man
_man5 = _group createunit ["Rocker1", [_pos select 0, (_pos select 1) , 0], [], 0.5, "Form"];
...
//Sniper
_man6 = _group createunit ["Rocker2", [_pos select 0, (_pos select 1), 0], [], 0.5, "Form"];
...
//Grenadier
_man7 = _group createunit ["Woodlander3", [_pos select 0, (_pos select 1), 0], [], 0.5, "Form"];
